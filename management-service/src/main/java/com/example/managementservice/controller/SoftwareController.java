...
public class SoftwareController {
    ...
    @PostMapping("/create")
    ResponseEntity<SoftwareDto> insertSoftware(@RequestBody SoftwareDto softwareDto) {
        SoftwareDto savedSoftwareDto = softwareService.insertSoftware(softwareDto);
    ...
    public ResponseEntity<SoftwareDto> getByAssetCode(@PathVariable("assetCode") String assetCode) {
        SoftwareDto softwareDto = softwareService.getSofwareByAssetCode(assetCode);
        return new ResponseEntity<>(softwareDto, HttpStatus.OK);
    }
}
